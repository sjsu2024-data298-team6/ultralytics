...
from ultralytics.nn.modules.ijepa.src.train import main as app_main
...
parser.add_argument(
    "--batch-launch", action="store_true", help="whether fname points to a file to batch-lauch several config files"
)
parser.add_argument(
    "--fname", type=str, help="yaml file containing config file names to launch", default="configs.yaml"
)
