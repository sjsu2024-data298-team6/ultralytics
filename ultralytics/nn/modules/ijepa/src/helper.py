...
import ultralytics.nn.modules.ijepa.src.models.vision_transformer as vit
from ultralytics.nn.modules.ijepa.src.utils.schedulers import WarmupCosineSchedule, CosineWDSchedule
from ultralytics.nn.modules.ijepa.src.utils.tensors import trunc_normal_
...
def init_opt(
    ...
    wd_scheduler = CosineWDSchedule(
        optimizer, ref_wd=wd, final_wd=final_wd, T_max=int(ipe_scale * num_epochs * iterations_per_epoch)
    )
